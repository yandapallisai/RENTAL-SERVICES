 ...
 else
 {
   ...
   re.action="log.php";
    ...
    <body style="background-color:skyblue">
        <div style="background-color:blue;height:100px;color:white;font-size:20px;" class="head"> 
        ...
        <h1 align="center"> sign in or create account</h1>
         ...
         <table align="center">
           ...
           <tr><td><a href="regester.php">regester<a/></td><td> <input type="submit" value="submit"  onclick="validate()"/></td></tr><br>
